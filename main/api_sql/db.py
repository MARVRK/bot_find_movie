...
class DataBase():
    ...
    def upload_data(self, name, date_of_release, category, movie_age, image):
        self.cursor.execute('INSERT INTO movies(name,date_of_release, category, movie_age, image) values(?,?,?,?,?)',
                            (name, date_of_release, category, movie_age, image))
        self.conn.commit()
    ...
    def fetch_all_data(self, id):
        self.cursor.execute('SELECT * from movies WHERE id = ?',
                            (id,))
        self.conn.commit()
